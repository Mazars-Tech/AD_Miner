...
from smolcard_class import SmolCard, dico_category
...
def render(
    ...
    with open("./render_%s/html/index.html" % arguments.cache_prefix, "w") as page_f:
        with open("sources/html/templates/main_header.html", "r") as header_f:
            ...
            modal_header = open("sources/html/templates/cards_modal_header.html", "r").read()
            modal_footer = """
                  </div>
        </div>
