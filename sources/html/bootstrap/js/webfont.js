...
(function (window, document, undefined) {
  ...
  A.prototype.compare = function (a) {
    return this.c > a.c ||
      ...
      (this.c === a.c && this.g === a.g && this.B > a.B)
      ? 1
      : this.c < a.c ||
        (this.c === a.c && this.g < a.g) ||
        (this.c === a.c && this.g === a.g && this.B < a.B)
  ...
  D.prototype.parse = function () {
    ...
    if (-1 != this.a.indexOf('MSIE') || -1 != this.a.indexOf('Trident/')) {
      ...
      a: if (
        ...
        null !== c.c
          ? (a = 'Presto')
          : (-1 != this.a.indexOf('Gecko') && (a = 'Gecko'),
            B(G(this.a, /rv:([^\)]+)/, 1))),
        ...
        (c = B(G(this.a, /Opera Mini\/([\d\.]+)/, 1))),
          (a = new C(
            ...
            0,
            b,
            new z(!1, !1, !1, !!this.k.fonts),
          ));
      else {
        if (
          -1 != this.a.indexOf('Version/') &&
          ((c = B(G(this.a, /Version\/([\d\.]+)/, 1))), null !== c.c)
        ) {
          a = new C(
            'Opera',
            0,
  ...
  function I(a) {
    ...
    'BuiltinBrowser' == e
      ...
      ? (f = G(a.a, /Silk\/([\d\._]+)/, 1))
      : 'Chrome' == e
      ? (f = G(a.a, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2))
      : -1 != a.a.indexOf('Version/')
      ? (f = G(a.a, /Version\/([\d\.\w]+)/, 1))
      : 'AdobeAIR' == e
      ? (f = G(a.a, /AdobeAIR\/([\d\.]+)/, 1))
      : 'Opera' == e
      ? (f = G(a.a, /OPR\/([\d.]+)/, 1))
      : 'PhantomJS' == e && (f = G(a.a, /PhantomJS\/([\d.]+)/, 1));
    f = B(f);
    g =
      'AdobeAIR' == e
        ? 2 < f.c || (2 == f.c && 5 <= f.g)
    ...
    return new C(
      ...
      new z(
        g,
        536 > d.c || (536 == d.c && 11 > d.g),
        'iPhone' == b || 'iPad' == b || 'iPod' == b || 'Macintosh' == b,
        !!a.k.fonts,
      ),
    );
  }
  ...
  function O(a, b) {
    this.d = a;
    this.H = b;
    this.t = this.d.createElement('span', { 'aria-hidden': 'true' }, this.H);
  }
  function P(a, b) {
    var c = a.t,
      d;
    ...
    c.style.cssText =
      'display:block;position:absolute;top:0px;left:0px;visibility:hidden;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:' +
      d +
      ';' +
      ('font-style:' + e + ';font-weight:' + (b.$ + '00') + ';');
  }
  function Q(a) {
    t(a.d, 'body', a.t);
  }
  ...
  function ja(a, b, c, d, e, f, g, h) {
    ...
    for (var p in R)
      R.hasOwnProperty(p) &&
        (P(a, new K(R[p], L(this.s))), (this.J[R[p]] = a.t.offsetWidth));
    a.remove();
  }
  var R = { Ea: 'serif', Da: 'sans-serif', Ca: 'monospace' };
  ...
  function ka(a) {
    var b = a.F.t.offsetWidth,
      c = a.G.t.offsetWidth;
    (b === a.J.serif && c === a.J['sans-serif']) || (a.m.Z && la(a, b, c))
      ? q() - a.za >= a.Y
        ? a.m.Z &&
          la(a, b, c) &&
          (null === a.da || a.da.hasOwnProperty(a.s.getName()))
          ? S(a, a.aa)
          : S(a, a.va)
        : ma(a)
      : S(a, a.aa);
  ...
  T.prototype.ka = function (a) {
    ...
    b.C &&
      u(
        b.p,
        [b.h.e(b.j, a.getName(), L(a).toString(), 'active')],
        [
  ...
  var xa = { Arimo: !0, Cousine: !0, Tinos: !0 };
  ...
  V.prototype.load = function (a) {
    ...
    'MSIE' == this.a.getName() && 1 != this.f.blocking
      ? ca(b, n(this.ba, this, a))
      : this.ba(a);
  };
  V.prototype.ba = function (a) {
    for (
      var b = this.d,
        c = new qa(this.f.api, w(b), this.f.text),
        d = this.f.families,
        e = d.length,
        f = 0;
      f < e;
        ...
        (d.__webfontfontdeckmodule__[c] = function (a, c) {
          for (var d = 0, p = c.fonts.length; d < p; ++d) {
            ...
            e.o.push(
              new K(
                m.name,
                fa('font-weight:' + m.weight + ';font-style:' + m.style),
              ),
            );
          }
          b(a);
